...
- Version 2.1 is protocol-v2 general availability with the fail-closed Codex model-routing graph validated and Claude live-client validation pending. Claude validation may be completed later by any authenticated Gurzu engineer on macOS or Linux and is not a release gate.
